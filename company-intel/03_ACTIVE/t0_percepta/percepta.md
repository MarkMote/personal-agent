...
## Quick Facts
- **Parent:** General Catalyst (AI transformation company)
- **Location:** NYC or Cambridge
- **Focus:** Embedding researchers into Fortune 500 companies
- **Leadership:** Athul Jacob (MIT CSAIL, Meta FAIR), Costis Daskalakis (MIT Professor, Nevanlinna Prize winner)

## The Opportunity
Percepta embeds engineers, product leaders, and researchers directly into Fortune 500 enterprises to solve nine-figure problems and build next-gen AI systems for the real economy.

## Target Roles
1. **Research PMs** - Scope high-value research problems with enterprise partners, turn insights into deployable capabilities
2. **Embedded Researchers** - Forward-deployed scientists who work hands-on inside Fortune 500s, partner with EPMs and AI Product Engineers

## Team Structure
- Deeply interdisciplinary research organization
- Blends foundation models, RL, OR, optimization, and theory
- Former team members from MIT, NYU, UC Berkeley, CMU, Microsoft Research, DeepMind, Apple SPG
- Split focus: Percepta Labs (future-facing research) + embedded deployments (real-world impact)
...
## Travel Requirements
- Occasional travel: 2-3 days every two months (US + Europe)

## Your Angle
**Why you fit:**
- PhD optimization + controls background aligns with interdisciplinary approach
- Technical founder experience = proven ability to bridge research and deployment
- Production AI systems experience (Roostr LLM pipeline) = relevant to embedded deployment model

## Key People
| Name | Role | Background |
|------|------|------------|
| Brandon Smouse | Partner @ Quantum (recruiting firm) | Initial contact |
