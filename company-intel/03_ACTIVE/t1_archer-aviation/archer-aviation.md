...
## Quick Facts
- **Location:** San Jose, CA (Bay Area) - appears non-remote or remote hard sell
- **Stage:** Public (NYSE: ACHR)
- **Focus:** eVTOL air taxi / urban air mobility
- **Product:** Midnight - electric vertical takeoff aircraft
- **Liquidity:** ~$2B (after $850M raise in 2025)

## Role Applied
- **Position:** Staff Autonomy Engineer
- **Contact:** Eddy Yu (Recruiter) - eyu@archer.com
- **Resume:** TBD (likely Chief Engineer)
- **Source:** Suresh referral (former Shield AI, now at Archer)

## Your Angle
**Hook:** PhD in aerospace GNC + trajectory optimization. Safe autonomy for aircraft is literally thesis work.
**Pitch:** JPL swarm navigation, AFRL docking guidance, Robotarium safety verification, perception systems at Pytheia
...
**What they do:** Building electric air taxis for urban transportation. The Midnight aircraft is a piloted eVTOL designed for short urban trips (airport to downtown, etc.).

**Key milestones:**
- Aug 2025: Completed 55-mile piloted flight at 150 mph
- Nov 2025: Acquired Hawthorne Municipal Airport in LA for $126M
- Dec 2024: Manufacturing facility completed in Georgia
- Official Air Taxi Provider of 2028 Olympic Games

**Regulatory path:**
- FAA certification expected 2026
- eIPP (eVTOL Integration Pilot Program) applications in with multiple US cities
- UAE operations testing underway

**Partnerships:** Japan Airlines, Saudi Arabia, Karem Aircraft, Jetex (Dubai)

## Technical Fit Assessment

**Strong match:**
- Aerospace GNC background - direct fit for eVTOL control systems
- Safe autonomy / certification-aware design (thesis work)
- Trajectory optimization, flight planning
- Real-time safety verification

**Gap:**
- eVTOL-specific domain knowledge (learnable)
- C++ may be rusty (same as Shield AI concern)

## Location Concern
Bay Area based. Mark listed Boston/San Diego/international as relocation options, not SF/Bay Area. Need to understand:
- Is remote possible at all?
- Hybrid arrangement?
- How hard is the "hard sell"?

Worth pursuing regardless - strong technical fit and warm referral path via Suresh.

## Notes
- Well-funded ($2B liquidity), not a runway risk
- Pre-revenue but clear path to commercialization (FAA 2026, Olympics 2028)
- Suresh just joined - good signal on company health
- Staff-level role suggests senior position with meaningful scope
