...
- **2017:** MIT Lincoln Lab intern (formal verification of CNNs)
- **2018:** MIT Lincoln Lab intern (neural network verification)
- **2018:** Stanford visiting researcher (collision-inclusive trajectory optimization)
- **2019:** NASA JPL intern (asteroid swarm satellites, published AIAA JGCD)
- **2020:** KAUST visiting student (safe autonomy)
...
### Notable Papers
1. "The Robotarium: A remotely accessible swarm robotics research testbed" (501 citations)
2. "The Robotarium: Globally impactful opportunities..." IEEE Control Systems (314 citations)
3. "An online approach to active set invariance" CDC 2018 (104 citations)
4. "Runtime assurance for safety-critical systems" IEEE Control Systems 2023 (101 citations)
5. "A scalable safety critical control framework for nonlinear systems" (91 citations)
...
### Pytheia (2021-2024) - CEO
- Computer vision and robotics focus
- Pivoted to LLM SaaS near end
- $20k investment → $300k ARR
- 2.5 years, shut down ~1.5 years ago

### Roostr (2024-present) - CTO
- AI-native freight forwarder
- 40% ownership, 2-person team
- $225k raised, ~$100k revenue run rate
- Runway just ended, evaluating fundraise vs. wind down

## Skills Stack
- **Technical:** GNC, control theory, optimization, CV, robotics, ML/AI, LLMs
- **Leadership:** CEO experience, CTO experience, hiring, fundraising, investor relations
- **Product:** Zero-to-one, pivots, finding PMF, fast iteration
...
2. Full-stack founder: can fundraise, hire, define roadmap, and write code
3. Systems thinker: physics → ML → deployment
4. Adaptable: pivoted CV/robotics to LLM SaaS successfully
5. Deep domain expertise in spacecraft controls exactly matching target companies
6. Zero-to-one experience (twice)
